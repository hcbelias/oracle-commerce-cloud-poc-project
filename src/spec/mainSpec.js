...
describe("main", () => {
  ...
  beforeEach(() => {
    ...
    mockery.mockModules(self,
      '../endPointTransceiver', '../metadata', '../grabber', '../widgetPutter', '../putter',
      '../i18n', '../utils', '../optionsUtils', '../CCLessCompiler', '../exitHandler', '../../package.json')
  ...
  it("should let you update instances and suppress config update", done => {
    ...
    self.mainModule.main().then(() => {
      ...
      expect(self.widgetPutter.enableUpdateInstances).toHaveBeenCalled()
      expect(self.widgetPutter.suppressConfigUpdate).toHaveBeenCalled()
      expect(self.endPointTransceiver.init).toHaveBeenCalledWith("http://somehost:8090", "admin", "admin", undefined, undefined, undefined)
      done()
    })
  })
